...
const Doctors = () => {
  ...
  const [filteredDoctor, setFilteredDocs] = useState([]);
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div
          className={`flex-col gap-4 text-sm texy-gray-600 ${
        ...
        <div className="w-full grid grid-cols-auto gap-4">
          {filteredDoctor &&
            filteredDoctor.map((item: any, ind: number) => (
              <div
                onClick={() => {
              ...
              >
                ...
                <div className="p-4">
                  <div
                    className={`flex items-center gap-4 text-sm text-center ${
